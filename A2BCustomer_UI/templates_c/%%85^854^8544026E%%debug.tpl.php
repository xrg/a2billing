<?php /* Smarty version 2.6.13, created on 2006-10-03 02:39:34
         compiled from file:/home/areski/public_html/svn/a2billing/trunk/A2BCustomer_UI/lib//Smarty/debug.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'assign_debug_info', 'file:/home/areski/public_html/svn/a2billing/trunk/A2BCustomer_UI/lib//Smarty/debug.tpl', 5, false),array('modifier', 'escape', 'file:/home/areski/public_html/svn/a2billing/trunk/A2BCustomer_UI/lib//Smarty/debug.tpl', 12, false),array('modifier', 'string_format', 'file:/home/areski/public_html/svn/a2billing/trunk/A2BCustomer_UI/lib//Smarty/debug.tpl', 12, false),array('modifier', 'debug_print_var', 'file:/home/areski/public_html/svn/a2billing/trunk/A2BCustomer_UI/lib//Smarty/debug.tpl', 18, false),)), $this); ?>
...
?>
		<tr bgcolor=<?php if (!(1 & $this->_sections['templates']['index'])): ?>#eeeeee<?php else: ?>#fafafa<?php endif; ?>><td colspan=2><tt><?php unset($this->_sections['indent']);
...
$this->_sections['templates']['last']       = ($this->_sections['templates']['iteration'] == $this->_sections['templates']['total']);
?>
		_smarty_console.document.write("<tr bgcolor=<?php if (!(1 & $this->_sections['templates']['index'])): ?>#eeeeee<?php else: ?>#fafafa<?php endif; ?>><td colspan=2><tt><?php unset($this->_sections['indent']);
$this->_sections['indent']['name'] = 'indent';
$this->_sections['indent']['loop'] = is_array($_loop=$this->_tpl_vars['_debug_tpls'][$this->_sections['templates']['index']]['depth']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['indent']['show'] = true;
$this->_sections['indent']['max'] = $this->_sections['indent']['loop'];
