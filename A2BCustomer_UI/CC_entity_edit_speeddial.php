                    ...
                    <TR> 
                      ...
                      <TD width="%75" valign="top" class="tableBodyRight" bgcolor="#CCCCCC">
                        <?php 
								...
								{								
						  ?>
                        <INPUT class="form_enter" name=<?php echo $FG_TABLE_EDITION[$i][1]?>  <?php echo $FG_TABLE_EDITION[$i][4]?> value="<?php if($VALID_SQL_REG_EXP){ echo stripslashes($list[0][$i]); }else{ echo $$FG_TABLE_EDITION[$i][1]; }?>"> 
						<?php 
      ...
      <br> 
                  ...
                  <TBODY>
                    ...
                    <TR> 
                      ...
                      <TD align="right"  width="5%"> <INPUT class="form_enter" title="<?php echo gettext("Remove this Speed Dial")?>" alt="<?php echo REMOVE_SPEEDDIAL?>" height=20 hspace=2 id=submit22 name=submit22 value="<?php echo gettext("Delete");?>" type="submit">
		      </TD>
                    </TR>                    
