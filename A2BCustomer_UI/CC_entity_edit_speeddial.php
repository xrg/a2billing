...
if ($form_action == "delete"){
	...
	if (!$res_delete){  echo "error deletion";
	}else{
                    ...
                    <TR> 
                      ...
                      <TD width="%75" valign="top" class="tableBodyRight" bgcolor="#CCCCCC">
                        <?php 
								...
								{								
						  ?>
                        <INPUT class="form_input_text" name=<?php echo $FG_TABLE_EDITION[$i][1]?>  <?php echo $FG_TABLE_EDITION[$i][4]?> value="<?php if($VALID_SQL_REG_EXP){ echo stripslashes($list[0][$i]); }else{ echo $$FG_TABLE_EDITION[$i][1]; }?>"> 
						<?php 
						  		}elseif (strtoupper ($FG_TABLE_EDITION[$i][3])==strtoupper ("POPUPVALUE"))
								{								
						  ?>
						...
						<a href="#" onclick="window.open('<?php echo $FG_TABLE_EDITION[$i][14]?>popup_formname=myForm&popup_fieldname=<?php echo $FG_TABLE_EDITION[$i][1]?>' <?php echo $FG_TABLE_EDITION[$i][15]?>);"><img src="images/icon_arrow_orange.gif"/></a>
                    ...
                    <TR> 					  
                      ...
                      <TD width="%75" valign="top" class="tableBodyRight" bgcolor="#CCCCCC"> 
						...
						<?php 
								...
								{								
						  ?>
                        <INPUT class="form_enter" name=<?php echo $FG_TABLE_ADITION[$i][1]?>  <?php echo $FG_TABLE_ADITION[$i][4]?> value="<?php if($VALID_SQL_REG_EXP){ echo stripslashes($list[0][$i]); }else{ echo $$FG_TABLE_ADITION[$i][1]; }?>"> 
						<a href="#" onclick="window.open('<?php echo $FG_TABLE_ADITION[$i][14]?>popup_formname=myForm&popup_fieldname=<?php echo $FG_TABLE_ADITION[$i][1]?>' <?php echo $FG_TABLE_ADITION[$i][15]?>);"><img src="images/icon_arrow_orange.gif"/></a>
                        ...
                        <?php     }elseif (strtoupper ($FG_TABLE_ADITION[$i][3])==strtoupper ("RADIOBUTTON")){
												...
												foreach ($radio_table as $radio_instance){
													...
													if ($FG_TABLE_ADITION[$i][2]==$radio_composant[1]){
														echo "checked";
													}
													echo ">";
												}								
      ...
      <br> 
                  ...
                  <TBODY>
                    ...
                    <TR> 
                      ...
                      <TD align="right"  width="5%"> <INPUT class="form_input_button" title="<?php echo gettext("Remove this Speed Dial")?>" alt="<?php echo REMOVE_SPEEDDIAL?>" height=20 hspace=2 id=submit22 name=submit22 value="<?php echo gettext("Delete");?>" type="submit">
		      </TD>
                    </TR>                    
