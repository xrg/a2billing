...
require('SOAP/Client.php');
	...
	// USAGE http://localhost/all/svn/a2billing/trunk/A2Billing_UI/api/SOAP/soap-card-client.php   

    //$endpoint = 'http://localhost/all/svn/a2billing/trunk/A2Billing_UI/api/SOAP/soap-card-server.php';
	$endpoint = 'http://localhost/~areski/A2B/a2billing/trunk/A2Billing_UI/api/SOAP/soap-card-server.php';
