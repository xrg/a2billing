...
include ("./form_data/FG_var_agent_invoicev.inc");
...
if ($agentid!='' || !is_null($agentid)){
	$HD_Form -> FG_EDITION_CLAUSE = str_replace("%id", "$agentid", $HD_Form -> FG_EDITION_CLAUSE);
}
...
<form name="searchform" id="searchform" method="post" action="A2B_entity_agent_invoicev.php">
