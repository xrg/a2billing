...
if ($entercustomer != "")
{
	...
	$QUERY = "Select id from cc_card t1 where username = $entercustomer";
	...
	*******/
	...
	$FG_TABLE_CLAUSE .="t1.starttime >(Select CASE  WHEN max(cover_enddate) IS NULL THEN '0001-01-01 01:00:00' ELSE max(cover_enddate) END from cc_invoices WHERE cardid = $customerID)";
