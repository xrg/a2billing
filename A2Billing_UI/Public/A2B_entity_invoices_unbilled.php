...
$DBHandle = DbConnect();
$num = 0;
$QUERY = "Select username, vat from cc_card t1 where t1.id = $cardid";
...
?>	
	<table  cellspacing="0" class="invoice_main_table">
	  ...
	  <tr>
	  <td align="right">
	  <a href="A2B_entity_unbilled_details1.php?exporttype=pdf"> </a>&nbsp;
	  </td>
	  </tr>
	  <?php }?>
      <tr>
...
?><table  cellspacing="0" class="invoice_main_table">
	 ...
	 <td>&nbsp;</td>
	  ...
	  <tr>
	 <td align="center"><?php echo gettext("No calls have been made yet!");?></td>
	 </tr> 
	  <tr>
	 <td>&nbsp;</td>
	 </tr> 
