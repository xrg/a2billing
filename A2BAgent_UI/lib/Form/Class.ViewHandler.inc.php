	 ...
	 ?>
		 		 ...
		 		 <?php  } ?>
					  ...
					  <TD align="center" vAlign=top class=tableBodyRight><?php
					   if($this->FG_EDITION){
						?>&nbsp; <a href="<?php echo $this->FG_EDITION_LINK?><?php echo $list[$ligne_number][$this->FG_NB_TABLE_COL]?>&stitle=<?php echo $stitle?>&site_id=<?php echo $list[$ligne_number][0]?>"<?php
						if (isset($this->FG_EDITION_CLASS)) echo "class=\"".$this->FG_EDITION_CLASS . '"';
						?> > <?php
						if (isset($this->FG_EDITION_TEXT))
							echo $this->FG_EDITION_TEXT;
							else {
								?><img src="<?php echo Images_Path_Main;?>/icon-edit.gif" border="0" title="<?php echo $this->FG_EDIT_ALT?>" alt="<?php echo $this->FG_EDIT_ALT?>"><?php
							}
						?></a><?php } ?>
					<?php if($this->FG_DELETION){
						?>&nbsp; <a href="<?php echo $this->FG_DELETION_LINK?><?php echo $list[$ligne_number][$this->FG_NB_TABLE_COL]?>&stitle=<?php echo $stitle?>"<?php
						if (isset($this->FG_DELETION_CLASS)) echo "class=\"".$this->FG_DELETION_CLASS . '"';
						?> > <?php
						if (isset($this->FG_DELETION_TEXT))
							echo $this->FG_DELETION_TEXT;
							else {
								?><img src="<?php echo Images_Path_Main;?>/icon-del.gif" border="0" title="<?php echo $this->FG_DELETE_ALT?>" alt="<?php echo $this->FG_DELETE_ALT?>"><?php
							}
						?></a><?php } ?>
					...
					?> <a href="<?php
								...
								if (isset($this->FG_OTHER_BUTTON1_CLASS))
									echo ' class="'.$this->FG_OTHER_BUTTON1_CLASS .'"';
								?> ><?php
						...
						<?php if($this->FG_OTHER_BUTTON2){ ?>
							<a href="<?php 
								...
								if (isset($this->FG_OTHER_BUTTON2_CLASS))
									echo ' class="'.$this->FG_OTHER_BUTTON2_CLASS .'"';
								?> ><?php
